    ...
    <div class="tables-container">
        ...
        <div class="table">
            ...
            <div class="table-details">
                ...
                <button type="submit"
                class="view-more-btn"
                <?= !$tableStatuses[2]['available'] ? 'style="opacity:0.5; cursor: no-drop;" disabled' : '' ?>>
                Book Now
                </button>
                </form>
        ...
        <div class="table">
            ...
            <div class="table-details">
                ...
                <button type="submit"
                class="view-more-btn"
                <?= !$tableStatuses[3]['available'] ? 'style="opacity:0.5; cursor: no-drop;" disabled' : '' ?>>
                Book Now
                </button>
                </form>
        ...
        <div class="table">
            ...
            <div class="table-details">
                ...
                <button type="submit"
                class="view-more-btn"
                <?= !$tableStatuses[4]['available'] ? 'style="opacity:0.5; cursor: no-drop;" disabled' : '' ?>>
                Book Now
                </button>
                </form>
