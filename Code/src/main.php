...
<body>
    ...
    <div class="section-background">
        <div class="about-us-container">
            ...
            <p>We, the <strong>SIPAT Group Ltd.</strong>, are a team of tech enthusiasts and billiards lovers who understand the frustration of long queues, uncertain wait times, and crowded halls. Our mission is simple: to modernize the billiards experience for both customers and business owners through smart, easy-to-use technology.</p>
